...
<div class="tieude">
	Giỏ hàng của bạn | <span>Xin chào bạn: <strong><em>${customer.name}</em></strong>
</div>
<c:if test="${mess!=null}">
	<div class="thongbao">
			...
			<tr>
				...
				<td>
					<form action="/cart/plus/${order.product.id}" method="post">
						<button class="button_edit">
							<img src="/resources/imgs/plus.png" width="10" height="10">
						</button>
					</form> ${order.numberProduct}
					<form action="/cart/subtract/${order.product.id}" method="post">
						<button class="button_edit">
							<img src="/resources/imgs/subtract.png" width="10" height="10">
						</button>
					</form>
				</td>
				...
				<td>
					<form action="/cart/delete/${order.product.id}" method="post">
						<button class="button_edit">
							<img src="/resources/imgs/deletered.png" width="30" height="30">
						</button>
					</form>
				</td>
			</tr>
		...
		<form action="/cart/order" method="post">
			<table>
				<tr>
					...
					<input type="radio" id="offline" name="pay" value="Offline" checked>
