...
<link rel="stylesheet" type="text/css"
	href="/resources/css/admincss.css" />
<script type="text/javascript" src="/resources/js/jquery-3.1.1.min.js"></script>
<script type="text/javascript" src="/resources/js/jquery-3.2.1.js"></script>
<script type="text/javascript" src="/resources/js/delete.js"></script>
<script type="text/javascript"
	src="/resources/js/tinymce/js/tinymce/jquery.tinymce.min.js"></script>
<script type="text/javascript"
	src="/resources/js/tinymce/js/tinymce/tinymce.min.js"></script>
	...
	<div class="wrapper">
		...
		<div class="content">
			<div class="box_contains">
				...
				<c:if test="${content=='bill/list'}">
					<%@ include file="BillManagement/list.jsp"%>
				</c:if>
				<c:if test="${content=='bill/update'}">
					<%@ include file="BillManagement/update.jsp"%>
				</c:if>
			</div>
		</div>
